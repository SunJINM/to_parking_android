 ...
 * Use the {@link CarParkFragment#newInstance} factory method to
...
public class CarParkFragment extends Fragment {
     ...
     * @return A new instance of fragment CarParkFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CarParkFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(rootView == null){
            rootView = inflater.inflate(R.layout.fragment_car_park, container, false);
        }
        initView();
    ...
    private void initView() {
        listView = rootView.findViewById(R.id.list_car_park_info);
        carParkId = rootView.findViewById(R.id.carParkId);
        address = rootView.findViewById(R.id.address);
        carParkName = rootView.findViewById(R.id.carParkName);
        ...
        try {
            ...
            getActivity().runOnUiThread(()->{
                ...
                SimpleAdapter adapter=new SimpleAdapter(
                        getContext(),
                        hashMapList,
                        R.layout.show_car_park_list,
                        new String[]{"carParkId","carParkName", "address"},
                        new int[]{
                                R.id.carParkId,
                                R.id.carParkName,
                                R.id.address
