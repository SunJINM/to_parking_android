...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2, String price) {
		...
		String value = "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""+ price + "\",\"subject\":\"1\",\"body\":\"我是测试数据\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}";
		System.out.println(value);
		keyValues.put("biz_content", value);
